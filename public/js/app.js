...
var BackboneViewMediator = (function() {
  ...
  BackboneViewMediator.prototype._checkHasElement = function(){
    if (!this.el) this.el = document.querySelector(this.selector)
  }

  BackboneViewMediator.prototype.render = function(renderConfig) {
  ...
  BackboneViewMediator.prototype.remove = function() {
    ...
    if (this.currentLayout){
      this.layouts[this.currentLayout].isRendered = false;
      this.el.innerHTML = '';
      this.currentLayout = null;
    }
  };
  ...
  BackboneViewMediator.prototype.renderLayout = function(layout) {

    // if the layout is new, all views must be unmounted/remounted
    if (!this.layouts[layout].isRendered) {
      ...
      mapObject(this.layouts, function(layout) {
  ...
  function initializeView(view, el, viewParams){
    view.controller = new view.factory(
      el,
      viewParams
    );
  ...
  BackboneViewMediator.prototype.renderViews = function(newView, params) {
    this._checkHasElement()

    mapObject(newView, function(viewName, el) {
      var view = this.views[viewName],
        viewParams = params ? params[viewName] : null;

      // if the view is already rendered, do not re-render
      // just call set on it's models for any params assigned to it.
      if (view.isRendered) {

        if (viewParams && view.controller.model) {
          view.controller.model.set(viewParams);
        }
...
},{"jquery":12,"underscore":13}],4:[function(require,module,exports){
"use strict";
...
},{"./layouts/MainLayout.html":15,"./views/Home/HomeView.js":17,"./views/Navbar/NavbarView.js":19,"backbone":3,"backbone-view-mediator":1,"jquery":12,"underscore":13}],15:[function(require,module,exports){
module.exports = "<div id='navigation-region'></div>\n<div id='content-region'></div>\n";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div>\n    <h3>Welcome to the Backbone Boilerplate</h3>\n\n    <p>\n        Try giving the home view a route parameter by clicking\n        <a href='#home/cool! views can refresh in responses to routes!'>here</a>\n    </p>\n\n    <p>";
...
},{"./HomeTemplate.hbs":16}],18:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class='pure-menu pure-menu-horizontal'>\n    <ul class='pure-menu-list'>\n        <li class='pure-menu-item'>\n            <a class='pure-menu-link' href='#home'>\n                Home\n            </a>\n        </li>\n    </ul>\n</div>\n";
  });
